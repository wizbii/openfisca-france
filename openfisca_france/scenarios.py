...
class Scenario(scenarios.AbstractScenario):
    ...
    def repair(self, test_case, groupless_individus):
        ...
        return test_case, dict(
            familles = individus_without_famille,
            menages = individus_without_menage,
            foyers_fiscaux = individus_without_foyer_fiscal,
            )
