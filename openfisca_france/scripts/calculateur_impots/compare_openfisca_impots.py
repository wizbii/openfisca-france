...
def compare(scenario, tested = False):
    ...
    # Sert à afficher le nom des variables retournées par le script
...
#    print fields['ITRED']['value']
        # S'il n'y a pas IINETIR et IRESTIR dans les résultats, on compare irpp à IINET (s'ils y sont c'est
        if iinet:
