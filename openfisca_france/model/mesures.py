...
class uc(Variable):
    ...
    def formula(menage, period, parameters):
        ...
        age = floor(age_en_mois_i / 12)
        is_adulte = (15 <= age) & (age <= 150)
        is_enfant = (0 <= age) & (age <= 14)

        uc_i = is_adulte * uc_adt + is_enfant * uc_enf

        return menage.sum(uc_i)
